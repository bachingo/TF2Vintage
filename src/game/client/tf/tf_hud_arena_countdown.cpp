...
public:
	CHudArenaCapPointCountdown( char const *pElementName );
...
// Purpose: 
//-----------------------------------------------------------------------------
CHudArenaCapPointCountdown::CHudArenaCapPointCountdown( char const *pElementName ) 
...
void CHudArenaCapPointCountdown::OnTick( void )
{
	...
	const int iTimeLeft = ceil( TFGameRules()->GetPointEnableTime() - gpGlobals->curtime );
