	...
	case AC_STATE_IDLE:
		{
			...
			// TF2V: This was slower by 25% before April 28 2010. (Day 955)
...
float CTFMinigun::GetProjectileDamage( void )
{
	...
	if ( TF2VIsContemporary( TF2V_DAY_MAJOR_LOVE_AND_WAR ) )
	{
		...
		if ( TF2VIsBetween( TF2V_DAY_MAJOR_LOVE_AND_WAR, 2487 ) )
		{
			// Love and War: Based on firing time exclusively.
			flSpinTime = GetFiringDuration();
		}
		else if ( TF2VIsBetween( 2487, TF2V_DAY_MAJOR_JUNGLE_INFERNO ) )
		{
