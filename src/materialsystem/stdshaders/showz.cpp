...
//			return "Wireframe";
	...
	SHADER_DRAW
	{
		SHADOW_STATE
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( showz_vs30 );
			SET_STATIC_VERTEX_SHADER( showz_vs30 );
		...
		DYNAMIC_STATE
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( showz_vs30 );
			SET_DYNAMIC_VERTEX_SHADER( showz_vs30 );
