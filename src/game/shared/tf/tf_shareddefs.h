...
enum
{
	...
	TF_LOADOUT_SLOT_MISC3,	// TF_LAST_COSMETIC_SLOT
	...
	TF_LOADOUT_SLOT_PAINT1,	// TF_FIRST_PAINT_SLOT
	TF_LOADOUT_SLOT_PAINT2,
	TF_LOADOUT_SLOT_PAINT3,
	TF_LOADOUT_SLOT_PAINT4,	// TF_LAST_PAINT_SLOT
...
#define TF_LAST_COSMETIC_SLOT TF_LOADOUT_SLOT_MISC3

#define TF_FIRST_TAUNT_SLOT	TF_LOADOUT_SLOT_TAUNT1
#define TF_LAST_TAUNT_SLOT TF_LOADOUT_SLOT_TAUNT8

#define TF_FIRST_PAINT_SLOT	TF_LOADOUT_SLOT_PAINT1
#define TF_LAST_PAINT_SLOT TF_LOADOUT_SLOT_PAINT4
...
#define TF_PLAYER_PAINT_COUNT		4		// Total amount of all paint slots.
