...
#define TF_BUFF_OFFENSE_COUNT 600
#define TF_BUFF_DEFENSE_COUNT 175
#define TF_BUFF_REGENONDAMAGE_OFFENSE_COUNT 600
#define TF_BUFF_REGENONDAMAGE_DEFENSE_COUNT 210
