...
#define TF_DAMAGE_CRIT_CHANCE_NEW				0.02f
#define TF_DAMAGE_CRIT_CHANCE_RAPID_NEW			0.02f
...
#define TF_BURNING_DMG_OLD				3
#define TF_BURNING_DMG_NEW				4

#define TF_AFTERBURN_BASE_DURATION_OLD 10.0f
#define TF_AFTERBURN_BASE_DURATION_NEW 7.5f
...
#define TF_REGEN_AMOUNT_OLD			1 			// Amount of health regenerated each regen.
#define TF_REGEN_AMOUNT_NEW			3 			// Amount of health regenerated each regen.

#define TF_REGEN_BOOST_OLD			3 			// Multiplier for health regenerated each regen when out of combat.
#define TF_REGEN_BOOST_NEW			2 			// Multiplier for health regenerated each regen when out of combat.
