...
bool CTFGrenadePipebombProjectile::DetonateStickies()
{
	...
	for ( int i = 0; i < count; i++ )
	{
		...
		if ( (TF2VIsContemporary(TF2V_DAY_SMISSMAS_2014)) && (TF2VIsAnachronistic(2472)) )
		{
...
void CTFGrenadePipebombProjectile::PipebombTouch( CBaseEntity *pOther )
{
	...
	if ( (TF2VIsContemporary(12)) && (TF2VIsAnachronistic(39)) )
	{
...
float CTFGrenadePipebombProjectile::GetDamageRadius() 
{
	...
	if ( (TF2VIsContemporary(TF2V_DAY_SMISSMAS_2014)) )
	{
		// winbomb prevention.
		// Air Det
