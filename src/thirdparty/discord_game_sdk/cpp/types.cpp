...
{
    Q_strncpy(internal_.username, username, 256);
...
{
    Q_strncpy(internal_.discriminator, discriminator, 8);
...
{
    Q_strncpy(internal_.avatar, avatar, 128);
...
{
    Q_strncpy(internal_.access_token, accessToken, 128);
...
{
    Q_strncpy(internal_.scopes, scopes, 1024);
...
{
    Q_strncpy(internal_.large_image, largeImage, 128);
...
{
    Q_strncpy(internal_.large_text, largeText, 128);
...
{
    Q_strncpy(internal_.small_image, smallImage, 128);
...
{
    Q_strncpy(internal_.small_text, smallText, 128);
...
{
    Q_strncpy(internal_.match, match, 128);
...
{
    Q_strncpy(internal_.join, join, 128);
...
{
    Q_strncpy(internal_.spectate, spectate, 128);
...
{
    Q_strncpy(internal_.name, name, 128);
...
{
    Q_strncpy(internal_.state, state, 128);
...
{
    Q_strncpy(internal_.details, details, 128);
...
{
    Q_strncpy(internal_.secret, secret, 128);
...
{
    Q_strncpy(internal_.currency, currency, 16);
...
{
    Q_strncpy(internal_.name, name, 256);
...
{
    Q_strncpy(internal_.shortcut, shortcut, 256);
...
{
    Q_strncpy(internal_.unlocked_at, unlockedAt, 64);
