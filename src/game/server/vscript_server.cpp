...
void RegisterScriptGameEventListener( const char* pszEventName )
{
	...
	ScriptGameEventListener().ListenForGameEvent( pszEventName );
}
...
void RegisterScriptHookListener( const char* pszEventName )
{
	...
	ScriptGameEventListener().ListenForScriptHook( pszEventName );
}

void CollectGameEventCallbacksInScope( HSCRIPT scope )
{
	ScriptGameEventListener().CollectGameEventCallbacksInScope( scope );
}
...
bool RunScriptHook( const char *pszHookName, HSCRIPT params )
{
	...
	return ScriptGameEventListener().FireScriptHook( pszHookName, params );
}
...
bool ScriptFireGameEvent( const char* szName, HSCRIPT params )
{
	...
	ScriptGameEventListener().RunGameEventCallbacks( szName, params );
	return true;
}
...
bool ScriptFireScriptHook( const char* szName, HSCRIPT params )
{
	...
	return ScriptGameEventListener().FireScriptHook( szName, params );
}
